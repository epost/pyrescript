...
module Language.PyreScript.Make
  (
    make
...
import qualified Language.PyreScript.Pretty as Pretty
...
import qualified Paths_pyrescript as Paths
...
buildMakeActions outputDir filePathMap foreigns usePrefix =
  ...
  codegen m _ exts = do
    ...
    rawJs <- Py.moduleToPy m foreignInclude
    ...
    let filePath = XXX.moduleNameToPyPath mn
        ...
        prefix = ["Generated by pysc version " ++ showVersion Paths.version | usePrefix]
